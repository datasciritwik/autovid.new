...
app = modal.App("Qwen2.5-14B-Instruct-1M", image=image)
...
class Model:
    ...
    def _generate_text(self, prompt: str, max_new_tokens=512):
    ...
    def infer(self, prompt: str = Form(...), x_api_key: str = Header(...)):
        """
